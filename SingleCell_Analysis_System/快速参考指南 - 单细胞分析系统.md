...
```r
# 1. 设置工作目录
setwd("/Users/wangyang/Desktop/SingleCell_Analysis_System")
...
```r
# ===== 必改参数 =====
WORK_DIR <- "/Users/wangyang/Desktop/SingleCell_Analysis_System"                    # 工作目录
DATA_FILE <- "/Users/wangyang/Desktop/SingleCell_Analysis_System/数据文件"         # 数据文件
